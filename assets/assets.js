...
export const workData = [
  {
    title: "Fresh Bites - AI-Powered Smart Food Ordering Platform",
    description:
      "AI-powered food ordering platform built with the MERN Stack, featuring authentication, AI food recommendations, order management, and an administrative dashboard.",
    ...
    github:
      "https://github.com/mohmadhusenkhimani/fresh-bites-ai-food-ordering-platform",
  },

  {
    ...
    description:
      "Full-stack MERN eCommerce platform featuring authentication, shopping cart management, online payment integration, order management, and an admin panel.",
...

  {
    ...
    description:
      "Professional business website developed with React.js and Tailwind CSS, featuring a modern responsive interface, user-focused design, and optimized web experience.",
